...
public class View extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        if (isGameWon) {
            g.drawString("You've won!", 140, 250);
            //JOptionPane.showMessageDialog(this, "You've won!","Красава", JOptionPane.INFORMATION_MESSAGE);
        } else if (isGameLost) {
            g.drawString("You've lost :(", 120, 250);
            //JOptionPane.showMessageDialog(this, "You've lost :(", "Лох", JOptionPane.INFORMATION_MESSAGE);
        }
    }
